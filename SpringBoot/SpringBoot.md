...
1. [`Spring/SpringBoot fundamental concepts`](#springspringboot-fundamental-concepts)
    ...
    2. [Dependency Injection](#dependency-injection)
        1. [Types of Injection in Spring](#types-of-injection-in-spring)
...
2. [`SpringBoot Annotation`](#springboot-annotation)
    1. [@SpringBootApplication](#springbootapplication)
        ...
        2. [Specialized Stereotypes](#specialized-stereotypes)
...
3. [`Spring Data`](#spring-data)
    ...
    4. [Reactive Repository](#reactive-repository)
    5. [Service](#service)

4. [`Spring Cloud`](#spring-cloud)
    1. [Spring Cloud Stream](#spring-cloud-stream)
